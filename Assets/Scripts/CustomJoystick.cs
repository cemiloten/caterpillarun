...
public sealed class CustomJoystick : MonoBehaviour, IPointerDownHandler, IDragHandler, IPointerUpHandler {
    ...
    [SerializeField] private bool resetInputOnRelease;
    ...
    public void OnPointerDown(PointerEventData eventData) {
        ...
        GameEvents.OnJoystickDown();
    }

    public void OnPointerUp(PointerEventData eventData) {
        if (resetInputOnRelease) {
            _input = Vector2.zero;
            handle.anchoredPosition = Vector2.zero;
        }

        GameEvents.OnJoystickUp();
    }
